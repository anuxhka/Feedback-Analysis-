...
<body>
  ...
  <span class="academic-year">Academic Year: <?php echo $_POST['year']; ?></span>
  ...
  ob_start();
           ...
           $selectedYear = $_POST['year']; // Get the selected year from the URL query parameter
           $sqlget = "SELECT * FROM addque WHERE year = '$selectedYear' ORDER BY category, id";
